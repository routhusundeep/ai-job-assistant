...
\subsection{Job Search Behavior}
Quantitative reviews of the job-search experience show that persistence, structured planning, and psychological resources explain much of the variation in employment outcomes \cite{vanhooft2021jobsearch,kanfer2001job,wanberg2012individual}. Daily diaries confirm that job-search self-efficacy shapes how people rebound from setbacks \cite{liu2014daily}, and practitioner narratives emphasize staying organized as social feeds churn with new postings \cite{vanhoye2022systematic,gursakal2020jobseeking}. These findings justify tools that capture each application, surface high-fit roles quickly, and keep motivation high by reducing busywork.

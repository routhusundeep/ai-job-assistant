...
\keywords{Do, Not, Use, This, Code, Put, the, Correct, Terms, for,
  Your, Paper}
%% A "teaser" image would normally span the page here. Commented to allow compilation
%% without an external asset. Uncomment and replace with a real figure when ready.
% \begin{teaserfigure}
